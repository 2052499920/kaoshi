      ...
      <div>
        ...
        >
          <div class="contenta">
            ...
            <el-form-item label="选择等级" prop="checkbox">
...
export default {
  ...
  methods: {
    ...
    visibleChange(val) {
      //打开关联教材下拉框
      if (val) {
        if (this.ruleForm.professionKind && this.ruleForm.checkbox.length > 0) {
    ...
    jian() {
      if (this.ruleForm.textboxList.length <= 2) {
        this.$message.error("最少2个选项");
      } else {
    ...
    jia() {
      ...
      } else if (this.ruleForm.textboxList.length == 3) {
        this.ruleForm.textboxList.push({
          id: "4",
          label: "D",
          value: "",
        });
      } else if (this.ruleForm.textboxList.length == 4) {
        this.ruleForm.textboxList.push({
          id: "5",
          label: "E",
          value: "",
    ...
    question() {
      this.$api.addQustionBanks(this.form).then((res) => {
        // console.log(res);
        if (res.code == 0) {
          ...
          this.ruleForm.radio = ""; //清空答案
          this.ruleForm.topic = ""; //清空题干(单选、多选)
          this.ruleForm.stems = ""; //题干
          this.ruleForm.sqaAnswer = ""; //简答题答案
          this.ruleForm.answerkeywords = ""; //简答题答案关键字
          this.ruleForm.gapFillingStem = ""; //填空题题干
          this.ruleForm.gapFillingAnswer = ""; //填空题答案
        } else if (res.code == 1) {
  ...
  created() {
    ...
    //   }
    // });
    // console.log(blankNameList, blankList);
  },
  computed: {},
  watch: {},
};
